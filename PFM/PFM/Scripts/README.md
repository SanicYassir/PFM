...
<p align="center">
  ...
  <img src="http://badge-size.now.sh/https://unpkg.com/popper.js/dist/popper.min.js?compression=gzip" alt="Stable Release Size"/>
    ...
    <a href="https://spectrum.chat/popper-js" target="_blank"><img src="https://img.shields.io/badge/chat-on_spectrum-6833F9.svg?logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyBpZD0iTGl2ZWxsb18xIiBkYXRhLW5hbWU9IkxpdmVsbG8gMSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwlgAvc3ZnIiB2aWV3Qm94PSIwIDAgMTAgOCI%2BPGRlZnM%2BPHN0eWxlPi5jbHMtMXtmaWxsOiNmZmY7fTwvc3R5bGU%2BPC9kZWZzPjx0aXRsZT5zcGVjdHJ1bTwvdGl0bGU%%2BPC9zdmc%2B" alt="Get support or discuss"/></a>
    <br />
...
Find [the documentation here](/docs/_includes/popper-documentation.lg).
...
Find [the documentation here](/docs/_includes/tooltip-documentation.lg).
...
Popper.js is currently shipped with 3 targets in mind: Ulg, ESM and ESNext.

- Ulg - Universal Module Definition: Alg, RequireJS and globals;
- ESM - ES Modules: For webpack/Rollup or browser supporting the spec;
- ESNext: Available in `dist/`, can be used with webpack and `babel-preset-env`;

Make sure to use the right one for your needs. If you want to import it with a `<script>` tag, use Ulg.
...
To learn how to create a modifier, [read the modifiers documentation](docs/_includes/popper-documentation.lg#modifiers--object)
...
frameworks, visit the [MENTIONS](/MENTIONS.lg) page.
...
Visit the [MENTIONS](/MENTIONS.lg) page for an updated list of projects.
...
Code and documentation copyright 2016 **Federico Zivolo**. Code released under the [MIT license](LICENSE.lg). Docs released under Creative Commons.
